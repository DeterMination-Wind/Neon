...
public final class RepoResolver{
    // 镜像地址,host 在每次请求前运行时解析为 IPv4(见 PlayMirrorResolver),解析失败回退域名原样
    private static final String modIndexUrl = "http://play.mindustry.men/github/repos/Anuken/mindustry-mods/mods.json";
    ...
    public static void loadModIndex(Cons<Boolean> done){
        ...
        Http.get(PlayMirrorResolver.resolveHost(modIndexUrl))
        .timeout(30000)
