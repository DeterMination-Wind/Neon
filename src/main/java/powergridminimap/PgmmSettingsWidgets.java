...
final class PgmmSettingsWidgets{
    ...
    static final class IconSliderSetting extends RbmStyle.IconSliderSetting{
    ...
    static final class IconTextSetting extends RbmStyle.IconTextSetting{
        IconTextSetting(String name, String def, arc.scene.style.Drawable icon, arc.func.Cons<String> changed){
            super(name, def, icon, changed);
        }
    }

    static final class IconIntFieldSetting extends RbmStyle.IconIntFieldSetting{
        IconIntFieldSetting(String name, int def, int min, int max, arc.scene.style.Drawable icon, arc.func.Intc changed){
            super(name, def, min, max, icon, changed);
        }
    }
}
