...
public class PowerGridMinimapMod extends mindustry.mod.Mod{
    ...
    public void bekBuildSettings(SettingsMenuDialog.SettingsTable table){
            ...
            if(!bekBundled) table.pref(new PgmmSettingsWidgets.IconCheckSetting(GithubUpdateCheck.enabledKey(), true, Icon.refreshSmall, null));
            if(!bekBundled) table.pref(new PgmmSettingsWidgets.IconCheckSetting(GithubUpdateCheck.showDialogKey(), true, Icon.infoSmall, null));
    }
    ...
    private void ensurePowerTableAttached(){
        ...
        if(!Core.app.isOnMainThread()){
            Core.app.post(this::ensurePowerTableAttached);
            return;
        }
        if(ui == null || ui.hudGroup == null) return;
        if(powerTable == null) powerTable = new PowerTableOverlay();
